...
<head>
    ...
    <title>クレジットカード情報登録 - Stripe</title>
...
<body class="antialiased bg-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <!-- 戻るリンク -->
                        <button onclick="history.back()" class="inline-flex items-center text-blue-600 hover:text-blue-700 mb-6 cursor-pointer bg-transparent border-0">
                            <i class="ri-arrow-left-line mr-1"></i>
                            戻る
                        </button>

                        <h1 class="text-2xl font-bold text-gray-900 mb-2">クレジットカード情報登録</h1>
                        <p class="text-gray-600 mb-2">参加費のお支払いに使用するクレジットカード情報を登録してください</p>
                        <p class="text-sm text-gray-500 mb-2">
                            申込番号: <span id="display-application-number" class="font-mono font-semibold text-blue-600">-</span>
                        </p>
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-semibold text-blue-900 mb-1">本人確認完了後に自動決済されます</p>
                                    <p class="text-sm text-blue-800">
                                        今回はクレジットカード情報の登録のみで、決済は行われません。<br>
                                        本人確認（eKYC）が完了した時点で、登録されたカードに自動的に課金されます。
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="setup-form">
                            ...
                            <button
                                type="submit"
                                class="w-full bg-blue-600 text-white py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                id="submit-button"
                            >
                                <span id="button-text">クレジットカード情報を登録する</span>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-6">
                        <h2 class="text-xl font-bold text-gray-900 mb-4">申込内容</h2>
                        
                        <div class="space-y-4">
                            <!-- 申込番号 -->
                            <div class="pb-4 border-b border-gray-200">
                                <div class="text-sm text-gray-600">申込番号</div>
                                <div class="font-mono font-semibold text-gray-900" id="summary-application-number">-</div>
                            </div>
                            ...
                            <div class="bg-yellow-50 rounded-lg p-4">
                                <div class="flex items-start">
                                    <i class="ri-time-line text-yellow-600 text-xl mr-2 mt-0.5"></i>
                                    <div>
                                        <div class="font-semibold text-yellow-900 text-sm mb-1">決済タイミング</div>
    ...
    if (!applicationId || !amount) {
        alert('申込情報が見つかりません。申込フォームからやり直してください。');
        window.location.href = 'index.php#application';
    }

    // 申込情報を表示
    document.getElementById('display-application-number').textContent = applicationNumber || '-';
    document.getElementById('summary-application-number').textContent = applicationNumber || '-';
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (!saveData.success) {
                console.warn('PaymentMethod保存エラー:', saveData.error);
            }
            
            // 成功メッセージ表示
            alert('カード情報の登録が完了しました！\n本人確認完了後に自動的に決済が実行されます。');
            
            // 登録完了ページへ遷移
            window.location.href = 'setup-complete.php';
